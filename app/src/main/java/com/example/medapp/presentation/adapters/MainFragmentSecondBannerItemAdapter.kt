...
import com.example.medapp.presentation.viewholders.MainFragmentSecondBannerViewHolder

class MainFragmentSecondBannerItemAdapter(val bannerList: List<MedCenter>): RecyclerView.Adapter<MainFragmentSecondBannerViewHolder>() {
