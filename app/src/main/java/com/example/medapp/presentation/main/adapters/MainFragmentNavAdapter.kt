...
import com.example.medapp.presentation.main.viewholders.MainFragmentNavViewHolder

class MainFragmentNavAdapter(val listOfServices: List<MedService>) :
    RecyclerView.Adapter<MainFragmentNavViewHolder>() {
